...
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,draggable:true,resizable:true,shadow:true,modal:true,border:true,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false,constrain:false});
})(jQuery);
(function($){
function _2ad(_2ae){
...
if(!t.length){
t=$("<a></a>").addClass(_3d1).appendTo(tool);
...
var _6b4=$("<a class=\"textbox-button spinner-button\"></a>").addClass(opts.clsLeft).appendTo(_6aa.spinner);
var _6b5=$("<a class=\"textbox-button spinner-button\"></a>").addClass(opts.clsRight).appendTo(_6aa.spinner);
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",resizeEdge:5,width:"100%",autoRowHeight:true,toolbar:null,striped:true,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",emptyMsg:"",rownumbers:true,singleSelect:true,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:true,pagePosition:"bottom",pageNumber:1,pageSize:20,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollOnSelect:true,scrollbarSize:18,rownumberWidth:30,editorHeight:31,headerEvents:{mouseover:_753(true),mouseout:_753(false),click:_757,dblclick:_75c,contextmenu:_75f},rowEvents:{mouseover:_761(true),mouseout:_761(false),click:_768,dblclick:_772,contextmenu:_776},rowStyler:function(_911,_912){
...
$("<a class=\"tagbox-remove\"></a>").appendTo(_c1f);
});
_c20(_c13);
...
var t=$("<a class=\"datebox-button-a\"></a>").html($.isFunction(btn.text)?btn.text(_c56):btn.text).appendTo(td);
...
$.fn.datetimebox.defaults=$.extend({},$.fn.datebox.defaults,{spinnerWidth:"100%",showSeconds:false,timeSeparator:":",panelEvents:{mousedown:function(e){
...
(function($){
function init(_c9d){
var _c9e=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_c9d);
var t=$(_c9d);
...
_cb1.html("<a class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_cb1.append("<a class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
}
